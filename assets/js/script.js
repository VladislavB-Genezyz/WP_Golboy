...
jQuery(document).on('ready', function($) {
  // Slider
  jQuery('#coin-slider').coinslider({width:940,height:310,opacity:1});

  // Radius Box
  jQuery('.menu_nav ul li a').css({"border-radius":"6px", "-moz-border-radius":"6px", "-webkit-border-radius":"6px"});
