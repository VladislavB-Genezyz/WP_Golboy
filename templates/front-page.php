      ...
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <p class="infopost">Posted on 
            ...
            by <a href="#">Admin</a> &nbsp;&nbsp;|&nbsp;&nbsp; Filed under 
            <a href="#">templates</a>, <a href="#">internet</a> &nbsp;&nbsp;|&nbsp;&nbsp; 
            <a href="#" class="com">Comments <span>11</span></a>
          </p>
          <div class="clr"></div>
          <div class="img">
            <img src="<?php echo get_template_directory_uri()?>/assets/images/img1.jpg" width="638" height="192" alt="" class="fl" />
          </div>
        ...
        <div class="article">
          ...
          <div class="clr"></div>
          <div class="img"><img src="<?php echo get_template_directory_uri()?>/assets/images/img2.jpg" width="638" height="192" alt="" class="fl" /></div>
          <div class="post_content">
