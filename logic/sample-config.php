    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'sponsor1_title',
                'type'     => 'text',
                'title'    => __( 'Sponsor 1 title', 'redux-framework-demo' ),
                'default'  => 'Brazzers'
            ),
            array(
                'id'       => 'sponsor1_text',
                'type'     => 'text',
                'title'    => __( 'Sponsor 1 text', 'redux-framework-demo' ),
                'default'  => 'brazzers'
            ),
            array(
                'id'       => 'sponsor1_href',
                'type'     => 'text',
                'title'    => __( 'Sponsor 1 href', 'redux-framework-demo' ),
                'default'  => 'https://www.youtube.com/watch?v=QRQHivXy75k'
            ),
        )
    ) );
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Sponsor2', 'redux-framework-demo' ),
        'id'               => 'sidebar-sponsors2',
        'subsection'       => true,
        'customizer_width' => '450px',
        'icon'             => 'el el-smiley',
        'fields'           => array(
            array(
                'id'       => 'sponsor2_title',
                'type'     => 'text',
                'title'    => __( 'Sponsor 2 title', 'redux-framework-demo' ),
                'default'  => 'Brazzers'
            ),
            array(
                'id'       => 'sponsor2_text',
                'type'     => 'text',
                'title'    => __( 'Sponsor 2 text', 'redux-framework-demo' ),
                'default'  => 'brazzers'
            ),
            array(
                'id'       => 'sponsor2_href',
                'type'     => 'text',
                'title'    => __( 'Sponsor 2 href', 'redux-framework-demo' ),
                'default'  => 'https://www.youtube.com/watch?v=QRQHivXy75k'
            ),
        )
    ) );
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Sponsor3', 'redux-framework-demo' ),
        'id'               => 'sidebar-sponsors3',
        'subsection'       => true,
        'customizer_width' => '450px',
        'icon'             => 'el el-smiley',
        'fields'           => array(
            ...
            array(
                'id'       => 'sponsor3_text',
                'type'     => 'text',
                'title'    => __( 'Sponsor 3 text', 'redux-framework-demo' ),
                'default'  => 'brazzers'
            ),
            array(
                'id'       => 'sponsor3_href',
                'type'     => 'text',
                'title'    => __( 'Sponsor 3 href', 'redux-framework-demo' ),
                'default'  => 'https://www.youtube.com/watch?v=QRQHivXy75k'
            ),
        )
    ) );
